  ...
  return (
    <>
      <form className="pt-5 px-5 sm:pt-12 sm:pl-16">
          ...
          <input className='w-full sm:w-[500px] mt-4 px-4 py-3 border ' type="text" placeholder='Title here' required />
          ...
          <br />
          <button type='summit' className='mt-8 w-40 h-12 bg-black text-white'>ADD</button>
      </form>
